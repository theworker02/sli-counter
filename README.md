...
[![npm](https://img.shields.io/npm/v/@magnexis/sli-counter.svg)](https://www.npmjs.com/package/@magnexis/sli-counter)

Package version **1.00** (`1.0.0`). Default branch is **`main`** — never `master`.

**Docs:** [GitHub Pages](https://theworker02.github.io/sli-counter/) · **Source:** [`theworker02/sli-counter`](https://github.com/theworker02/sli-counter) · **Release 1.00:** [`v1.0.0`](https://github.com/theworker02/sli-counter/releases/tag/v1.0.0) · **npm:** [`@magnexis/sli-counter`](https://www.npmjs.com/package/@magnexis/sli-counter)
...
```bash
npm install -g @magnexis/sli-counter
sli-counter --help
```

Package page: https://www.npmjs.com/package/@magnexis/sli-counter
